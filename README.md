...
세번째로 환경오염이라는 문제도 무시할 수 없습니다.
혹시 지나다니면서 현수막을 만져보신 분 있으실까요? 현수막은 대부분 플라스틱이 포함된 합성섬유로 만들어집니다. 보통 70% 정도의 현수막은 소각하며, 이 현수막을 소각할 시 탄소와 발암물질이 매우 많이 나오죠. 현수막 1개 당 4kg의 온실가스와 다이옥신 등의 1급 발암물질을 배출합니다.
