...
주제 선정 배경은 크게 3가지입니다.<br>
첫번째로 보행자 사고 예방 목적입니다. 최근 언론에서 자전거 전용도로에서 달리던 자전거를 향해 바람에 휘발린 불법 현수막이 덮침으로 인해 발생한 전치 3주 이상의 상해 사례, 현수막 줄에 걸린 가로등이 강풍에 뽑혀 도로를 건너던 행인의 머리를 가격하는 사례들이 발생하고 있음을 보도했습니다. 불법 길거리 현수막으로 인한 사고는 큰 인명 피해를 야기하기에 이를 사전에 탐지하여 예방하는데 목적이 있는 프로젝트입니다.<br><br>
...
두번째로 옥외광고물법 개정안입니다. 작년 12월 개정된 옥외광고물법으로 인해 정치적 목적의 현수막 게시가 활성화되고 있습니다. 이에 따라 일명 '정당현수막'이 우후죽순으로 늘어났습니다. 관련 민원 현황으로
...
세번째로 탄소 배출 문제입니다. 현수막은 대부분 플라스틱이 포함된 합성섬유로 만들어집니다. 일반적으로 70% 정도의 현수막은 소각하며, 이 현수막을 소각할 시 탄소와 발암물질을 배출하게 됩니다. 현수막 1개 당 4kg의 온실가스와 다이옥신 등의 1급 발암물질이 발생합니다. 이번 프로젝트를 활용하여 불법 현수막 단속을 강화시킨다면 무분별하게 생산되는 불법 현수막을 감소시켜 탄소 중립 실천에 기여할 수 있을 것입니다.  

기술적인 프로세스로 사전에 수집한 차량 운행 데이터에 Object Detection(Yolov8)을 활용하여 합/불법 현수막을 추출하고 OCR(PaddleOCR, Naver Clova OCR)을 활용하여 각 현수막별 텍스트를 추출한뒤 ChatGPT 
